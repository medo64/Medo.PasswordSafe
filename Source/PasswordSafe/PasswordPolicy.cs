...
namespace Medo.Security.Cryptography.PasswordSafe {
    ...
    public class PasswordPolicy {
        ...
        public PasswordPolicy(string name, int passwordLength) {
            this.Name = name;
            this.TotalPasswordLength = passwordLength;
        }

        internal PasswordPolicy(PasswordPolicyCollection owner, string name, PasswordPolicyStyle style, int totalPasswordLength, int minimumLowercaseCount, int minimumUppercaseCount, int minimumDigitCount, int minimumSymbolCount, char[] specialSymbolSet) {
            this.Name = name;
            this.Style = style;
        ...
        private readonly PasswordPolicyCollection Owner;
        ...
        public override bool Equals(object obj) {
            if (obj is PasswordPolicy other) {
        ...
        public override int GetHashCode() {
            return this.Name.GetHashCode() ^ (int)this.Style;
        }
